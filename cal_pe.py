...
#  '''
#
sql = ''' SELECT id, biz_date, code, pe_ttm, pb from xueqiu_hs WHERE biz_date = '2017-10-20' and code in
    (select SUBSTRING(stock_code,1,6) from index_constituent_current where index_code = '000300')
'''
#
#
